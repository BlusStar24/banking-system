` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_beneficiary_upsert`(
  IN p_user_id        VARCHAR(36),
  IN p_type           ENUM('INTERNAL','EXTERNAL'),
  IN p_bank_id        VARCHAR(16),       -- NULL nếu INTERNAL
  IN p_account_or_card VARCHAR(64),
  IN p_display_name    VARCHAR(255),
  IN p_verified_name   VARCHAR(255)      -- NULL nếu chưa tra
)
main: BEGIN
  -- (user_id, type, bank_id, account_or_card) unique
  INSERT INTO beneficiaries (user_id, type, bank_id, account_or_card, display_name, last_verified_name, verified_at)
  VALUES (p_user_id, p_type, p_bank_id, p_account_or_card, p_display_name, p_verified_name, CURRENT_TIMESTAMP)
  ON DUPLICATE KEY UPDATE
    display_name      = VALUES(display_name),
    last_verified_name= VALUES(last_verified_name),
    verified_at       = IFNULL(VALUES(last_verified_name), last_verified_name); -- có tên thì cập nhật time
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_name_enquiry_upsert` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_name_enquiry_upsert`(
  IN p_bank_id        VARCHAR(16),
  IN p_account_or_card VARCHAR(64),
  IN p_account_name    VARCHAR(255),
  IN p_provider_ref    VARCHAR(64)
)
main: BEGIN
  -- banks.bank_id và name_enquiry_cache PK (bank_id, account_or_card) đã có
  INSERT INTO name_enquiry_cache (bank_id, account_or_card, account_name, provider_ref, verified_at)
  VALUES (p_bank_id, p_account_or_card, p_account_name, p_provider_ref, CURRENT_TIMESTAMP)
  ON DUPLICATE KEY UPDATE
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_transfer_external_request` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_transfer_external_request`(
  IN  p_tx_id            VARCHAR(36),
  IN  p_from_account_id  VARCHAR(36),
  IN  p_to_bank_id       VARCHAR(16),
  IN  p_to_external_ref  VARCHAR(64),   -- số TK/thẻ ngân hàng ngoài
  IN  p_counter_name     VARCHAR(255),  -- tên người nhận (nếu đã tra)
  IN  p_amount           DECIMAL(18,2),
  IN  p_currency         CHAR(3),
  IN  p_description      TEXT,
  IN  p_client_req_id    VARCHAR(64),
  OUT p_error_code       VARCHAR(32),
  OUT p_error_detail     VARCHAR(255)
)
main: BEGIN
  DECLARE v_from_cust VARCHAR(255);
  DECLARE v_from_bal  DECIMAL(18,2);
  DECLARE v_now       DATETIME(6);

  DECLARE EXIT HANDLER FOR SQLEXCEPTION
  BEGIN
    ROLLBACK;
    SET p_error_code   = COALESCE(p_error_code, 'EXCEPTION');
    SET p_error_detail = COALESCE(p_error_detail, 'Unhandled SQL exception');
  END;

  SET p_error_code = NULL; 
  SET p_error_detail = NULL;
  SET v_now = NOW(6);

  -- Idempotency
  IF p_client_req_id IS NOT NULL THEN
    IF EXISTS (SELECT 1 FROM transactions WHERE client_request_id = p_client_req_id) THEN
      SET p_error_code='IDEMPOTENT_HIT';
      SET p_error_detail='client_request_id already used';
      LEAVE main;
    END IF;
  END IF;

  -- Ngân hàng đích hợp lệ?
  IF NOT EXISTS (SELECT 1 FROM banks WHERE bank_id = p_to_bank_id) THEN
    SET p_error_code='BANK_UNKNOWN'; 
    SET p_error_detail='invalid to_bank_id';
    LEAVE main;
  END IF;
  ...
  SELECT balance, customer_id INTO v_from_bal, v_from_cust
  FROM accounts WHERE account_id = p_from_account_id FOR UPDATE;

  IF v_from_bal IS NULL THEN
    SET p_error_code='ACC_NOT_FOUND'; 
    SET p_error_detail='from account missing';
    ROLLBACK; LEAVE main;
  END IF;

  -- Chặn blacklist
  IF EXISTS (SELECT 1 FROM customers c WHERE c.customer_id=v_from_cust AND c.blacklisted=1)
     OR EXISTS (SELECT 1 FROM blacklist b WHERE b.customer_id=v_from_cust) THEN
    SET p_error_code='BLACKLISTED'; 
    SET p_error_detail='sender blacklisted';
    ROLLBACK; LEAVE main;
  END IF;
  ...
  IF p_amount <= 0 THEN
    ...
    SET p_error_detail='amount <= 0';
    ROLLBACK; LEAVE main;
  END IF;

  IF v_from_bal < p_amount THEN
    SET p_error_code='INSUFFICIENT_FUNDS'; 
    SET p_error_detail='not enough balance';
    ROLLBACK; LEAVE main;
  END IF;

  -- Đảm bảo tài khoản clearing tồn tại
  IF NOT EXISTS (SELECT 1 FROM accounts WHERE account_id='external_liability') THEN
    SET p_error_code='CONFIG_ERROR'; 
    SET p_error_detail='missing external_liability account';
    ROLLBACK; LEAVE main;
  END IF;

  -- Tạo transaction EXTERNAL → pending_settlement
  INSERT INTO transactions(
    transaction_id, from_account_id, to_external_ref, to_bank_id,
    amount, currency, description, status, created_at, type,
    client_request_id, counterparty_name, pre_balance, post_balance
  ) VALUES (
    p_tx_id, p_from_account_id, p_to_external_ref, p_to_bank_id,
    p_amount, p_currency, p_description, 'pending_settlement', v_now, 'EXTERNAL',
    p_client_req_id, p_counter_name, v_from_bal, v_from_bal - p_amount
  );

  -- Ghi sổ: Nợ from_account, Có external_liability
  INSERT INTO ledger_entries(entry_id, transaction_id, account_id, direction, amount, currency)
  VALUES (UUID(), p_tx_id, p_from_account_id,     'DEBIT',  p_amount, p_currency),
         (UUID(), p_tx_id, 'external_liability', 'CREDIT', p_amount, p_currency);

  -- Cập nhật số dư
  UPDATE accounts SET balance = balance - p_amount WHERE account_id = p_from_account_id;
  UPDATE accounts SET balance = balance + p_amount WHERE account_id = 'external_liability';
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_transfer_external_settle` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_transfer_external_settle`(
  IN  p_tx_id          VARCHAR(36),
  IN  p_success        TINYINT(1),
  IN  p_failure_code   VARCHAR(32),
  IN  p_failure_detail VARCHAR(255)
)
main: BEGIN
  DECLARE v_amount   DECIMAL(18,2);
  DECLARE v_currency CHAR(3);
  DECLARE v_status   VARCHAR(32);
  DECLARE v_from     VARCHAR(36);

  DECLARE EXIT HANDLER FOR SQLEXCEPTION
  BEGIN
    ROLLBACK;
    -- không set OUT vì SP này không có OUT; rollback là đủ
  END;

  START TRANSACTION;

  -- Khóa transaction để đọc chắc chắn
  SELECT amount, currency, status, from_account_id INTO v_amount, v_currency, v_status, v_from
  FROM transactions
  WHERE transaction_id = p_tx_id
  FOR UPDATE;

  -- Không tồn tại hoặc không đúng trạng thái
  IF v_status IS NULL THEN
    ROLLBACK; LEAVE main;
  END IF;
  IF v_status <> 'pending_settlement' THEN
    -- tránh double-settlement
    ROLLBACK; LEAVE main;
  END IF;
  ...
  IF p_success = 1 THEN
    -- Thành công: tất toán clearing
    INSERT INTO ledger_entries(entry_id, transaction_id, account_id, direction, amount, currency)
    VALUES (UUID(), p_tx_id, 'external_liability', 'DEBIT', v_amount, v_currency);

    UPDATE accounts SET balance = balance - v_amount
    WHERE account_id = 'external_liability';

    UPDATE transactions
      SET status='completed'
    WHERE transaction_id = p_tx_id;
  ELSE
    -- Thất bại: hoàn tiền về from_account & đảo clearing
    INSERT INTO refunds(refund_id, transaction_id, reason, amount)
    VALUES (UUID(), p_tx_id, COALESCE(p_failure_code,'FAILED'), v_amount);

    -- + from_account (CREDIT), - clearing (DEBIT)
    UPDATE accounts SET balance = balance + v_amount WHERE account_id = v_from;
    UPDATE accounts SET balance = balance - v_amount WHERE account_id = 'external_liability';

    INSERT INTO ledger_entries(entry_id, transaction_id, account_id, direction, amount, currency)
    VALUES (UUID(), p_tx_id, v_from,               'CREDIT', v_amount, v_currency),
           (UUID(), p_tx_id, 'external_liability', 'DEBIT',  v_amount, v_currency);

    UPDATE transactions
      SET status='failed', failure_code=p_failure_code, failure_detail=p_failure_detail
    WHERE transaction_id = p_tx_id;
  END IF;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_transfer_internal` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_transfer_internal`(
  IN  p_tx_id            VARCHAR(36),
  IN  p_from_account_id  VARCHAR(36),
...
main: BEGIN
  DECLARE v_from_cust VARCHAR(255);
  DECLARE v_to_cust   VARCHAR(255);
  DECLARE v_from_bal  DECIMAL(18,2);
  DECLARE v_to_bal    DECIMAL(18,2);
  DECLARE v_now       DATETIME(6);

  -- Handler: nếu có SQLEXCEPTION thì rollback và set lỗi mặc định
  DECLARE EXIT HANDLER FOR SQLEXCEPTION
  BEGIN
    ROLLBACK;
    SET p_error_code   = COALESCE(p_error_code, 'EXCEPTION');
  ...
  IF p_from_account_id < p_to_account_id THEN
    SELECT balance, customer_id INTO v_from_bal, v_from_cust
    FROM accounts WHERE account_id = p_from_account_id FOR UPDATE;
    SELECT balance, customer_id INTO v_to_bal, v_to_cust
  ...
  -- Kiểm tra tồn tại
  IF v_from_bal IS NULL OR v_to_bal IS NULL THEN
    SET p_error_code='ACC_NOT_FOUND'; 
    SET p_error_detail='account missing';
    ROLLBACK; LEAVE main;
  END IF;
  ...
  -- (Tuỳ chọn) kiểm tra currency khớp với accounts.currency
  ...
  -- Tạo transaction (INTERNAL)
  INSERT INTO transactions(
    transaction_id, from_account_id, to_internal_account_id,
    amount, currency, description, status, created_at, type,
    client_request_id, pre_balance, post_balance
  ) VALUES (
    p_tx_id, p_from_account_id, p_to_account_id,
    p_amount, p_currency, p_description, 'approved', v_now, 'INTERNAL',
    p_client_req_id, v_from_bal, v_from_bal - p_amount
  );

  -- Ghi sổ kép
  INSERT INTO ledger_entries(entry_id, transaction_id, account_id, direction, amount, currency)
  VALUES (UUID(), p_tx_id, p_from_account_id, 'DEBIT',  p_amount, p_currency),
         (UUID(), p_tx_id, p_to_account_id,   'CREDIT', p_amount, p_currency);
...
-- Dump completed on 2025-08-11 15:03:11
